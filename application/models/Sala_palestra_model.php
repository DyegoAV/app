...
class Sala_palestra_model extends CI_Model
{
    ...
    {
        $this->db->select('sala_palestra.*, local.nome as local_entrega_nome, regiao_administrativa.nome as regiao_administrativa_nome');
        $this->db->join('local', 'sala_palestra.local_entrega = local.id');
