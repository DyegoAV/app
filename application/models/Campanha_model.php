...
class Campanha_model extends CI_Model
{
    ...
    {
        $this->db->select('TBP01_INSTITUICAO.*, regiao_administrativa.nome as regiao_administrativa_nome, TBH01_ENDERECO.NO_CIDADE, TBH01_ENDERECO.SG_UF, TBC02_ABRANGENCIA_INSTITUICAO.NU_TBC02, TBH02_TELEFONE.NU_DDD, TBH02_TELEFONE.NU_TELEFONE, x_campanha_instituicao_locais.local_coleta, x_campanha_instituicao_locais.local_evento');
        ...
        $this->db->join('x_campanha_instituicao_locais', 'TBC02_ABRANGENCIA_INSTITUICAO.NU_TBC02 = x_campanha_instituicao_locais.NU_TBC02', 'LEFT');
